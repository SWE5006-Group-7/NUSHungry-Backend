...
public interface FavoriteRepository extends JpaRepository<Favorite, Long> {
    ...
    List<Favorite> findByUserIdOrderBySortOrderDescCreatedAtDesc(Long userId);
    ...
    @Modifying
    @Transactional
    @Query("DELETE FROM Favorite f WHERE f.id = :favoriteId AND f.userId = :userId")
    void deleteByIdAndUser(@Param("favoriteId") Long favoriteId, @Param("userId") Long userId);
}
